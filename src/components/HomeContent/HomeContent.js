  ...
  return (
    <>
      <div className="homeContent">
        <NavigationSidebar
          handleRef1={handleRef1}
          handleRef2={handleRef2}
          handleRef3={handleRef3}
          handleRef4={handleRef4}
          handleRef5={handleRef5}
          width={width}
        ...
        <div className="description">
          ...
          wordpress. Feel free to have a free call or mail me.
        </div>
